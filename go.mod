module github.com/aws-controllers-k8s/dms-controller

go 1.25.0

require (
	github.com/aws-controllers-k8s/ec2-controller v1.12.0
	github.com/aws-controllers-k8s/iam-controller v1.6.4
	...
	github.com/aws-controllers-k8s/s3-controller v1.5.0

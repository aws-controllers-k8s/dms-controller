...
{{- define "ack-dms-controller.app.name" -}}
...
*/}}
{{- define "ack-dms-controller.app.fullname" -}}
...
{{- define "ack-dms-controller.chart.name-version" -}}
{{- printf "%s-%s" .Chart.Name .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{/* The name of the service account to use */}}
{{- define "ack-dms-controller.service-account.name" -}}
    {{ default "default" .Values.serviceAccount.name }}
{{- end -}}

{{- define "ack-dms-controller.watch-namespace" -}}
...
{{- define "ack-dms-controller.aws.credentials.secret_mount_path" -}}
{{- "/var/run/secrets/aws" -}}
{{- end -}}

{{/* The path the shared credentials file is mounted */}}
{{- define "ack-dms-controller.aws.credentials.path" -}}
{{ $secret_mount_path := include "ack-dms-controller.aws.credentials.secret_mount_path" . }}
{{- printf "%s/%s" $secret_mount_path .Values.aws.credentials.secretKey -}}
{{- end -}}

{{/* The rules a of ClusterRole or Role */}}
{{- define "ack-dms-controller.rbac-rules" -}}
rules:
- apiGroups:
  - ""
  resources:
...
{{- define "ack-dms-controller.feature-gates" -}}
{{- $list := list -}}

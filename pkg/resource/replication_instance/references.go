...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.KerberosAuthenticationSettings != nil {
		if desiredKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretIAMRef != nil {
			if latestKO.Spec.KerberosAuthenticationSettings == nil {
				latestKO.Spec.KerberosAuthenticationSettings = &svcapitypes.KerberosAuthenticationSettings{}
			}
			if latestKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretIAMRef == nil {
				latestKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretIAMRef = desiredKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretIAMRef
			}
		}
		if desiredKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretRef != nil {
			if latestKO.Spec.KerberosAuthenticationSettings == nil {
				latestKO.Spec.KerberosAuthenticationSettings = &svcapitypes.KerberosAuthenticationSettings{}
			}
			if latestKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretRef == nil {
				latestKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretRef = desiredKO.Spec.KerberosAuthenticationSettings.KeyCacheSecretRef
			}
		}
	}

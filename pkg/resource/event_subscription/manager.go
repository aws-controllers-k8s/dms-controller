...
// +kubebuilder:rbac:groups=dms.services.k8s.aws,resources=eventsubscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dms.services.k8s.aws,resources=eventsubscriptions/status,verbs=get;update;patch
